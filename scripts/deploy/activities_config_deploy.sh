...
APP_NAME=activities-config-microservice
APP_DIR=$APP_NAME

LOG_DIR=log

NEXUS_URL=http://192.168.1.31:8082/nexus/service/local/artifact/maven/content
GROUP_ID=com.amhzing.activities-config
...
sudo update-rc.d $APP_NAME defaults 10 # priority 10 implies that there may be others depending on this starting first
